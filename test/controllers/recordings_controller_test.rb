...
class RecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recording" do
    assert_difference('Recording.count') do
      post recordings_url, params: { recording: { call_date: @recording.call_date, caller_id: @recording.caller_id, copied_to_mp3: @recording.copied_to_mp3, recording_folder: @recording.recording_folder } }
    end
  ...
  test "should update recording" do
    patch recording_url(@recording), params: { recording: { call_date: @recording.call_date, caller_id: @recording.caller_id, copied_to_mp3: @recording.copied_to_mp3, recording_folder: @recording.recording_folder } }
